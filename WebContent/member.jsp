...
<body>
    ...
    <form action="member_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <p>주소: <input type="text" id="sample6_address" name="address1"></p>
        <p>상세주소: <input type="text" id="sample6_detailAddress" name="address2"></p>
        <p>참고항목: <input type="text" id="sample6_extraAddress" name="address3"></p>
